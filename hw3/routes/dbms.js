...
var host = "35.185.225.103";    //from GCloud instance (change to match your db) 
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "Barbara2022";  //password (change to match your db, yes this is very poor practice)
